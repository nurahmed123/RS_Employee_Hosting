  ...
  return domLoaded ? (
    <motion.div {...rest} className="w-full max-w-[350px]">
      <button
        ...
        className="block w-full overflow-hidden transition-all duration-200 rounded-lg shadow-xl group bg-bg-secondary dark:shadow-2xl hover:shadow-2xl hover:-translate-y-1"
      >
